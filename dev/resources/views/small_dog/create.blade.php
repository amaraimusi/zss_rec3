...
<head>
	...
	<script src="{{ asset('/js/SmallDog/create.js')  . $ver_str}} }}" defer></script>
	...
	<link href="{{ asset('/css/SmallDog/create.css')  . $ver_str}}" rel="stylesheet">
	
	<title>子犬管理・新規登録フォーム</title>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page">子犬管理・新規登録フォーム</li>
  </ol>
</nav>
...
<div>
	<div class="form_w" >
		<form method="POST" action="{{ url('small_dog/store') }}" onsubmit="return checkDoublePress()">
			@csrf
			<!-- CBBXS-3006 -->
			<div class="row">
				<label for="dog_val" class="col-12 col-md-5 col-form-label">イヌ数値</label>
				<div class="col-12 col-md-7">
					<input name="dog_val" type="text"  class="form-control form-control-lg" placeholder="イヌ数値" value="{{old('dog_val')}}">
				</div>
			</div>
			<div class="row">
				<label for="small_dog_name" class="col-12 col-md-5 col-form-label">子犬名</label>
				<div class="col-12 col-md-7">
					<input name="small_dog_name" type="text"  class="form-control form-control-lg" placeholder="子犬名" value="{{old('small_dog_name')}}">
				</div>
			</div>
			<div class="row">
				<label for="small_dog_date" class="col-12 col-md-5 col-form-label">子犬日付</label>
				<div class="col-12 col-md-7">
					<input name="small_dog_date" type="text"  class="form-control form-control-lg" placeholder="子犬日付" value="{{old('small_dog_date')}}">
				</div>
			</div>
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<select name="dog_type" class="form-control form-control-lg">
						@foreach (dogTypeList as $dog_type => $dog_type_name)
							<option value="{{ $dog_type }}" @selected(old('dog_type') == $dog_type)>
								{{ $dog_type_name }}
							</option>
						@endforeach
					</select>
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="dog_dt" type="text"  class="form-control form-control-lg" placeholder="子犬保護日時" value="{{old('dog_dt')}}">
				</div>
			</div>
			<div class="row">
