...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page">ユーザー管理管理・新規登録フォーム</li>
  </ol>
</nav>
...
<div>
	<div class="form_w" >
		<form id="form1" method="POST" action="{{ url('user_mng/store') }}" onsubmit="return checkDoublePress()" enctype="multipart/form-data">
			@csrf
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="name" type="date"  class="form-control form-control-lg" placeholder="name" value="{{old('name', $ent->name)}}">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="email" type="date"  class="form-control form-control-lg" placeholder="email" value="{{old('email', $ent->email)}}">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="nickname" type="date"  class="form-control form-control-lg" placeholder="nickname" value="{{old('nickname', $ent->nickname)}}">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="password" type="date"  class="form-control form-control-lg" placeholder="password" value="{{old('password', $ent->password)}}">
				</div>
			</div>
