...
<head>
	...
	<script src="{{ asset('/js/Knowledge/create.js')  . $ver_str}} }}" defer></script>
	...
	<link href="{{ asset('/css/Knowledge/create.css')  . $ver_str}}" rel="stylesheet">
	
	<title>教え管理・新規登録フォーム</title>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page">教え管理・新規登録フォーム</li>
  </ol>
</nav>
...
<div>
	<div class="form_w" >
		<form id="form1" method="POST" action="{{ url('knowledge/store') }}" onsubmit="return checkDoublePress()" enctype="multipart/form-data">
			@csrf
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="doc_name" type="date"  class="form-control form-control-lg" placeholder="doc_name" value="{{old('doc_name', $ent->doc_name)}}">
				</div>
			</div>
