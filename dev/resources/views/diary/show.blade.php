...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page">日誌管理・詳細フォーム</li>
  </ol>
</nav>
...
<div>
	<div class="form_w" >
		<form method="POST" action="{{ url('diary/update') }}">
			@csrf
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">{{ $ent-> category}}</div>
			</div>

			<div class="row">
				<label for="diary_date" class="col-12 col-md-5 col-form-label">日誌日付</label>
				<div class="col-12 col-md-7">{{ $ent-> diary_date}}</div>
			</div>

			<div class="row">
				<label for="diary_note" class="col-12 col-md-5 col-form-label">日誌</label>
				<div class="col-12 col-md-7">
					<div style="white-space:pre-wrap; word-wrap:break-word;">{{ $ent->diary_note }}</div>
				</div>
			</div>
