...
<head>
	...
	<script src="{{ asset('/js/KlCategory/edit.js')  . $ver_str}} }}" defer></script>
	...
	<link href="{{ asset('/css/KlCategory/edit.css')  . $ver_str}}" rel="stylesheet">
	
	<title>教えカテゴリ管理・編集フォーム</title>
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
	...
	<li class="breadcrumb-item active" aria-current="page">教えカテゴリ管理・編集フォーム</li>
  </ol>
</nav>
...
<div>
	<div class="form_w" >
		<form id="form1" method="POST" action="{{ url('kl_category/update') }}" enctype="multipart/form-data">
			@csrf
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="kl_category_name" type="text"  class="form-control form-control-lg" placeholder="kl_category_name" value="{{old('kl_category_name', $ent->kl_category_name)}}" required  title="カテゴリ名を入力してください。">
				</div>
			</div>
			...
			<div class="row">
				...
				<div class="col-12 col-md-7">
					<input name="category_code" type="text"  class="form-control form-control-lg" placeholder="category_code" value="{{old('category_code', $ent->category_code)}}" required  title="カテゴリコードを入力してください。">
				</div>
			</div>
